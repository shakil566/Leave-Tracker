                ...
                <div class="col-md-8 margin-top-10">
                    ...
                    <div class="card card-primary">
                        <div class="card-header">
                            <h3 class="card-title">@lang('english.UPDATE_LEAVE_APPLICATION')</h3>
                        </div>
                        <!-- /.card-header -->
                        <!-- form start -->
                        {{ Form::model($leave, array('route' => array('leaveApplication.update', $leave->id), 'method' => 'PATCH', 'class' => 'form-horizontal', 'id' => 'leaveApplicationEditForm')) }}

                        <div class="card-body">
                            <div class="form-group">
                                <label for="title">@lang('english.NAME')<span class="text-danger"> *</span></label>
