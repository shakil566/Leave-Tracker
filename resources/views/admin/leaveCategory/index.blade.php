                    ...
                    <div class="col-12">
                        ...
                        <div class="card">
                            <div class="card-header">
                                <h3 class="card-title">@lang('english.LEAVE_CATEGORY_DETAILS')</h3>
                                <a href="{{ url('admin/leaveCategory/create') }}"
                                        ...
                                        @if (!empty($categoryArr))
                                            ...
                                            @foreach ($categoryArr as $value)
                                                <tr class="text-center">
                                                    ...
                                                    <td>
                                                        {{ Form::open(['url' => 'admin/leaveCategory/' . $value->id, 'id' => 'delete']) }}
                                                        {{ Form::hidden('_method', 'DELETE') }}
                                                        <a class='btn btn-primary btn-xs'
                                                            href="{{ URL::to('admin/leaveCategory/' . $value->id . '/edit') }}"
