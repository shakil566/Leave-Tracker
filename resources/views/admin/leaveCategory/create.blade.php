                ...
                <div class="col-md-8 margin-top-10">
                    ...
                    <div class="card card-primary">
                        <div class="card-header">
                            <h3 class="card-title">@lang('english.CREATE_NEW_LEAVE_CATEGORY')</h3>
                        </div>
                        <!-- /.card-header -->
                        <!-- form start -->
                        {{ Form::open(['role' => 'form', 'url' => 'admin/leaveCategory', 'class' => 'form-horizontal', 'id' => 'createleaveCategory']) }}
                        ...
                        <div class="card-body">
                            ...
                            <div class="form-group">
                                ...
                                {{ Form::textarea('description', Request::get('description'), ['id' => 'description', 'rows' => '2', 'class' => 'form-control', 'placeholder' => 'Enter Description']) }}
