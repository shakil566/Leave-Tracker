...
<div class="content-wrapper">
    ...
    <section class="content-header">
        <div class="container-fluid">
            <div class="row mb-2">
                <div class="col-sm-6">
                    <h1>@lang('english.EMPLOYEES')</h1>
                </div>
                <div class="col-sm-6">
                    <ol class="breadcrumb float-sm-right">
                        <li class="breadcrumb-item"><a href="{{ url('/dashboard') }}">@lang('english.HOME')</a></li>
                        <li class="breadcrumb-item active">@lang('english.EMPLOYEES')</li>
                    </ol>
                </div>
            </div>
        </div><!-- /.container-fluid -->
                ...
                <div class="col-12">
                    ...
                    <div class="card">
                        <div class="card-header">
                            <h3 class="card-title">@lang('english.EMPLOYEES_DETAILS')</h3>
                            <a href="{{ url('admin/employees/create') }}" class="btn btn-sm btn-info float-right"><i class="fas fa-plus"></i> @lang('english.CREATE_NEW')</a>
                        </div>
                        <!-- /.card-header -->
                        <div class="card-body">
                            <table id="dataTable" class="table table-bordered table-striped">
                                ...
                                <tbody>
                                    ...
                                    <tr class="text-center">
                                        ...
                                        <td>
                                            {{ Form::open(array('url' => 'admin/employees/' . $value->id, 'id' => 'delete')) }}
                                            {{ Form::hidden('_method', 'DELETE') }}

                                            <a class='btn btn-info btn-xs tooltips' href="{{ URL::to('admin/employees/activate/' . $value->id ) }}" data-rel="tooltip" title="@if($value->status == '1') Click here to Inactivate @else Click here to Activate @endif" data-container="body" data-trigger="hover" data-placement="top">
                                                @if($value->status == '1')
                                            ...
                                            <a class='btn btn-primary btn-xs tooltips' href="{{ URL::to('admin/employees/' . $value->id . '/edit') }}" title="Edit User" data-container="body" data-trigger="hover" data-placement="top">
