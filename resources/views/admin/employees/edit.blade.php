                ...
                <div class="col-md-8 margin-top-10">
                    ...
                    <div class="card card-primary">
                        <div class="card-header">
                            <h3 class="card-title">@lang('english.EDIT_EMPLOYEES')</h3>
                        </div>
                        <!-- /.card-header -->
                        <!-- form start -->
                        {{ Form::model($user, ['route' => ['employees.update', $user->id], 'method' => 'PUT', 'files' => true, 'class' => 'form-horizontal', 'id' => 'userId']) }}
                        ...
                        <div class="card-footer">
                            ...
                            <a href="{{ URL::to('/admin/employees') }}" class="btn btn-danger"><i class="fas fa-times"></i> @lang('english.CANCEL')</a>
                        </div>
                        {{ Form::close() }}
                    </div>
                    <!-- /.card -->
